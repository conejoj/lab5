...
?>
    ...
    <head>
        ...
        <title>Main Page - EMS Admin</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-gradient-primary">
            <!-- Navbar Brand-->
                ...
                <a class="navbar-brand ps-3" href="index.html" style="">John Brown University</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed text-white" href="index.html">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Conejo's Education Management System</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-md-8">
                                <div class="card custom-card bg-primary text-white mb-4">
                                    <div class="card-body" style="text-align: center;">Students</div>
                            ...
                            <div class="col-xl-6 col-md-8">
                                <div class="card custom-card bg-primary text-white mb-4">
                                    <div class="card-body" style="text-align: center;">Faculty</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-6 col-md-8">
                                <div class="card custom-card bg-primary text-white mb-4">
                                    <div class="card-body" style="text-align: center;">Departments</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-6 col-md-8">
                                <div class="card custom-card bg-primary text-white mb-4">
                                    <div class="card-body" style="text-align: center;">Courses</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-6 col-md-8">
                                <div class="card custom-card bg-primary text-white mb-4">
                                    <div class="card-body" style="text-align: center;">Add a Faculty</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href='javascript:;' onclick='toggleData("S");'>View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                            ...
                            <div class="col-xl-6 col-md-8">
                                <div class="card custom-card bg-primary text-white mb-4">
                                    <div class="card-body" style="text-align: center;">Add a Student</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href='javascript:;' onclick='toggleData("S");'>View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
 ...
 */
            .custom-card {
                ...
                .custom-card .card-footer {
                    background-color: rgba(255, 255, 255, 0.2); /* Add background color with transparency */
                }
            :root {
                --bs-blue: #0d6efd;
                --bs-indigo: #6610f2;
...
*/
            ...
            .card {
                ...
                --bs-card-box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); 
